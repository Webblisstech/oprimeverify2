...
<br>
    ...
    <div>
       <h5 style="color: red;"><b>If you use WhatsApp business u are on ur own ooo nah 50/50 chance of getting banned ❌ </b></h5> <br>
       <hr>
       <p>if you try one number and is not dropping code click on delete order and request for another one, request for code only once</p>
    </div>
        @if ($errors->any())
